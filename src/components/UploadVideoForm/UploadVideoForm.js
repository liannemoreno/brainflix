        ...
        <form className="upload__form">
            ...
            <div className="upload__form-wrapper">
                <div className="upload__form-title">
                    <label className="upload__form-title--label" for="videoTitle">TITLE YOUR VIDEO</label>
                ...
                <div className="upload__form-description">
                    <label className="upload__form-description--label" for="videoDescription" >ADD A VIDEO DESCRIPTION</label>
